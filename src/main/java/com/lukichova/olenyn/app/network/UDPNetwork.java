...
public class UDPNetwork implements Network {
    ...
    @Override
    public Packet receive() throws interruptedConnectionException, wrongCrc1Exception, wrongBMagicException, wrongCrc2Exception, wrongDecryptException, IOException {
      //  try {
